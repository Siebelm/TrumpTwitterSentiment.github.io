...
var svg2 = d3.select("#_2_investigation").append("svg")
...
var Title = svg2.append("text")
		...
		.text("Tweets on Russia Investigation");	
...
// loading data
d3.csv("2_Timeline_Data/investigation_timeline.csv", 
...
function (data) {
    ...
    var freqGroup = ["Investigation"]
    var freqColors = ["#595AB7"]
    ...
    var line = svg2
      ...
      .append("path")
        ...
        .attr("d", d3.line()
          ...
          .y(function(d) { return y(+d.Investigation) })
        )
        .attr("stroke", function(d){ return freqColor("Investigation") })
	...
	var mousemove = function() {
		...
		.attr("cy", y(selectedData2.Investigation))
		focusText
		.html("Frequency:&nbsp;" + selectedData2.Investigation)
		.attr("x", x(selectedData2.date))
		.attr("y", y(selectedData2.Investigation)-35)
		}
