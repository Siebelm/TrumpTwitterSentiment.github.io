...
var svg2 = d3.select("#_2_policy").append("svg")
...
// loading data
d3.csv("2_Timeline_Data/policy_timeline.csv", 
...
function(data) {
    ...
    var freqGroup = ["All", "Economic", "Diplomacy", "Immigration"]
    var freqColors = ["#595AB7", "#259286", "#BD3613", "#EAE3CB"]
